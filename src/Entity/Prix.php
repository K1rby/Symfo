 ...
 * Prix
 *
 * @ORM\Table(name="prix", indexes={@ORM\Index(name="id_tarif", columns={"id_tarif"}), @ORM\Index(name="id_classe", columns={"id_classe"}), @ORM\Index(name="id_voyage", columns={"id_voyage"})})
 * @ORM\Entity
 */
class Prix
{
